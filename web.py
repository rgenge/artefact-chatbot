    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            try:
                ...
                result={'answer':get_agent(customer_id).handle(message)}; status=200
